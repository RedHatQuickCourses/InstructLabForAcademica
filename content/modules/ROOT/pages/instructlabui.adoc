...
. Fill the first seed example with context and associated 3 sample question and answer pairs as shown in the following screen capture.
+
image::first-seed-example.png[First seed example, 80%, 80%]

. Similarly, fill in the remaining 4 seed examples.
